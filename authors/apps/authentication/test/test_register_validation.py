...
class UserAuthenticationTestCase(BaseTest):
    ...
    def test_if_email_field_is_empty(self):
        ...
        self.assertEqual(
            test_data.data["errors"]["email"][0], "Email field is required."
        )
    ...
    def test_if_email_is_valid(self):
        ...
        self.assertEqual(
            test_data.data["errors"]["email"][0], "Enter a valid email address."
        )
    ...
    def test_if_username_field_is_empty(self):
        ...
        self.assertEqual(
            test_data.data["errors"]["username"][0], "Username field is required."
        )
    ...
    def test_if_username_is_available(self):
        ...
        self.assertEqual(
            test_data.data["errors"]["username"][0],
    ...
    def test_if_password_field_is_empty(self):
        ...
        self.assertEqual(
            test_data.data["errors"]["password"][0], "Password field is required."
        )
    ...
    def test_if_password_is_valid_length(self):
        ...
        self.assertEqual(
            test_data.data["errors"]["password"][0],

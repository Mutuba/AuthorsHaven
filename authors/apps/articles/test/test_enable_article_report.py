...
#             path="/api/articles/how-to-your-dragon/reports",
...
#         token = res.data["token"]
#         response = self.client.post(
#             path="/api/articles/how-to-your-dragon/report",
#             HTTP_AUTHORIZATION="Bearer " + token,
#         )
...
#         }
#         response = self.client.post(path="/api/users/login/", data=data, format="json")
...
#         token = response.data["token"]
#         response = self.client.get(
#             path="/api/articles/how-to-feed-your-/reports",
#             HTTP_AUTHORIZATION="Bearer " + token,
#             format="json",
#         )
#         self.assertEqual(

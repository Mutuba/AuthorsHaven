...
#         """
#         response = self.client.post(self.SIGN_UP_URL, self.user1, format="json")
#         response = self.client.post(
#             reverse("authentication:user_login"), self.user1, format="json"
#         )
...
#         """
#         response = self.client.post(self.SIGN_UP_URL, self.user2, format="json")
#         response = self.client.post(
#             reverse("authentication:user_login"), self.user2, format="json"
#         )
#         token = response.data["token"]
#         return token
...
#         """
#         response = self.client.post(self.SIGN_UP_URL, self.user3, format="json")
#         response = self.client.post(
#             reverse("authentication:user_login"), self.user3, format="json"
#         )
#         token = response.data["token"]
#         return token
...
#         """
#         response = self.client.post(self.SIGN_UP_URL, self.user4, format="json")
#         response = self.client.post(
#             reverse("authentication:user_login"), self.user4, format="json"
#         )
#         token = response.data["token"]
#         return token
